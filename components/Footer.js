      ...
      <div className={`container ${styles.grid}`}>
        ...
        <div>
          ...
          <div style={{ display: 'flex', gap: '3rem', alignItems: 'flex-start' }}>
            <ul className={`footer-links ${styles.linksList}`} style={{ fontSize: '0.9rem' }}>
              <li><Magnetic strength={0.1}><Link href="/projets">{t('footer.projects')}</Link></Magnetic></li>
              <li><Magnetic strength={0.1}><Link href="/clients">{t('footer.clients')}</Link></Magnetic></li>
              <li><Magnetic strength={0.1}><Link href="/partenaires">{t('header.partners')}</Link></Magnetic></li>
              <li><Magnetic strength={0.1}><Link href="/nous-suivre">{t('footer.follow_us')}</Link></Magnetic></li>
              <li><Magnetic strength={0.1}><Link href="/blog">{t('header.blog')}</Link></Magnetic></li>
              <li><Magnetic strength={0.1}><Link href="/lexique">{t('footer.glossary')}</Link></Magnetic></li>
              <li><Magnetic strength={0.1}><Link href="/plan-du-site">{t('header.sitemap')}</Link></Magnetic></li>
              <li><Magnetic strength={0.1}><Link href="/mentions-legales">{t('footer.legal')}</Link></Magnetic></li>
              <li><Magnetic strength={0.1}><Link href="/vieprivee">{t('footer.privacy')}</Link></Magnetic></li>
              <li><Magnetic strength={0.1}><Link href="/privacy">{t('footer.cookies')}</Link></Magnetic></li>
            </ul>
