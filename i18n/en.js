export const en = {
  ...
  about: {
    ...
    team: {
      ...
      members: {
        frank: { name: "Frank Le Gall", role: "Co-Manager", desc: "Project management, urban planning & infrastructure.", email: "franck.legall@urbateam.fr", phone: "02 98 84 29 65" },
        laura: { name: "Laura Charretteur", role: "Co-Manager", desc: "Land issues, topography & management.", email: "laura.charretteur@urbateam.fr", phone: "02 98 84 29 65" },
        yves: { name: "Yves Jégot", role: "Infrastructure Project Manager", desc: "Expert in road design and diverse networks.", email: "yves.jegot@urbateam.fr", phone: "06 84 90 62 20" },
        trang: { name: "Trang Stephan", role: "Infrastructure Project Manager", desc: "Specialist in technical design and infrastructure monitoring.", email: "trang.stephan@urbateam.fr", phone: "06 77 97 93 96" },
        camille: { name: "Camille Lormeteau", role: "Landscape Designer", desc: "Landscape design and environmental integration.", email: "camille.lormeteau@urbateam.fr", phone: "06 78 73 03 26" },
        urbanistes: { role: "Urban Planners & Landscape Architects", desc: "Design and development of urban spaces." },
        engineers: { role: "Infrastructure Engineers", desc: "Technical design of roads and networks." },
        topographers: { role: "Surveying Technicians", desc: "High-precision field surveys and layouts." },
        drafters: { role: "Draftspeople", desc: "3D modeling and production of development plans." },
        lawyers: { role: "Legal Experts", desc: "Legal support on land law and co-ownership." },
        assistants: { role: "Executive Assistants", desc: "Administrative, financial management and client relations." }
      }
    },
    quality: {
  ...
  project: {
    ...
    types: {
      division: {
        ...
        steps: [
          { title: "Feasibility Study & Quote", desc: "Analysis of the urban planning document (PLU/PLUi) and land constraints (access, utilities) to ensure the project is buildable and legal." },
          { title: "Topographic Survey", desc: "Intervention of our teams on the field to precisely measure the existing situation (boundaries, elevations, visible networks)." },
          { title: "Division Project & Boundary Marking", desc: "Creation of the division plan and meeting with neighbors to legally validate the property lines (contradictory boundary marking)." },
          { title: "Administrative Validation (DP)", desc: "Submission of the Preliminary Declaration (DP) or Development Permit to the city hall. Instruction usually takes 1 month." },
          { title: "Surveying Document (DMPC)", desc: "Upon approval from the city hall, drafting of the official document updating the Tax Cadastre plan." },
          { title: "Notary Deed", desc: "The division is now official. The plans and land documents are attached to the promise and then to the notarized deed of sale." }
        ]
      },
      bornage: {
        ...
        steps: [
          { title: "Legal Research & Quote", desc: "Analysis of property titles of the applicant and neighbors, search in land archives and the Cadastre." },
          { title: "On-site Survey", desc: "The surveying technician measures physical elements (fences, hedges, walls, old markers)." },
          { title: "Contradictory Meeting", desc: "Meeting on the field with ALL neighboring owners to propose and negotiate the future property line." },
          { title: "Boundary Marking Minutes (PV)", desc: "Drafting of the official legal act finalizing the agreement. It must be signed by all parties." },
          { title: "Staking the Boundaries", desc: "Once the PV is signed, physical materialization of the boundary on the ground (placing markers or surveying nails)." },
          { title: "OGE Archiving", desc: "Permanent recording and security of the file on the Order of Chartered Surveyors portal (GéoFoncier), guaranteeing the boundary for life." }
        ]
      },
      lotissement: {
        ...
        steps: [
          { title: "Sketch & Feasibility", desc: "Development of an initial planning scheme taking into account environmental, legal (PLU) and budgetary constraints." },
          { title: "Development Permit (PA)", desc: "Constitution and submission of the complete administrative file to the prefecture or city hall (Water Act, environmental evaluation...)." },
          { title: "Tender Documents (DCE)", desc: "Detailed technical development of the project (execution civil engineering plans) and launch of the tender with roadwork companies." },
          { title: "Works Direction (MOE)", desc: "Rigorous monitoring of the construction site, weekly meetings, validation of network installation (water, electricity, sanitation)." },
          { title: "Site Acceptance (DAACT)", desc: "Resolution of punch list items, environmental compliance check and signature of the completion declaration." },
          { title: "Final Staking of Lots", desc: "Final placement of boundary markers for each new lot created before final commercialization." }
        ]
      },
      topo: {
        ...
        steps: [
          { title: "Need Definition", desc: "Exchange with the architect or client on the expected level of precision and the final plan scale." },
          { title: "Data Acquisition (Field)", desc: "Terrestrial survey with 3D scanner, total station or drone flyover." },
          { title: "Office Processing (CAD/BIM)", desc: "Processing of 3D point clouds and software modeling of facades, walls, and elevations (contour lines)." },
          { title: "Plan Finalization", desc: "Drafting the streetscape or site plan with all visible networks and vegetation." },
          { title: "Architectural Delivery", desc: "Delivery of the validated topographic model (DWG/DXF, PDF and BIM formats)." }
        ]
      }
    },
    geofoncier: {
