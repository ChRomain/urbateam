export const en = {
  ...
  "hero": {
    ...
    "title_part2": "in Western Brittany",
    "description": "URBATEAM accompanies you from design to completion. Land Surveying cabinet, urban planners and infrastructure engineering (VRD) based in Saint-Renan (Brest) and Douarnenez.",
    "cta_contact": "Tell us about your projects",
    "cta_more": "Learn more"
  },
  "stats": {
    "creation": {
      "number": "1983",
      "label": "Founded in",
      "desc": "An expertise anchored and recognized in Western Brittany."
    },
    "collaborators": {
      "label": "Dedicated collaborators",
      "desc": "Pluridisciplinary surveyors, planners and engineers."
    },
    "projects": {
      "label": "Large-scale projects",
      "desc": "From individual housing to regional eco-neighborhoods."
    }
  },
  "values": {
    ...
    "items": {
      "bornage": {
        ...
        "missions": [
          {
            "title": "Boundary marking",
            "desc": "Legal definition and physical staking of limits."
          },
          {
            "title": "Archive research",
            "desc": "Research in land archives and property deeds analysis."
          },
          {
            "title": "Boundary stones placement",
            "desc": "Physical marking of boundaries on site."
          },
          {
            "title": "Easements & Legal advice",
      ...
      "division": {
        ...
        "missions": [
          {
            "title": "Land division",
            "desc": "Creation of building plots (DMPC cadastral update)."
          },
          {
            "title": "Feasibility study",
            "desc": "Analysis of local urban plans (PLU) to verify constructibility."
          },
          {
            "title": "Prior declaration",
            "desc": "Constitution and filing of division requests to town halls."
          },
          {
            "title": "Surveying & Staking",
      ...
      "copropriete": {
        ...
        "missions": [
          {
            "title": "Co-ownership setup",
            "desc": "Calculation of shares and division plans."
          },
          {
            "title": "Volume division",
            "desc": "Management of complex property groups in 3D volumes."
          },
          {
            "title": "Co-ownership updates",
            "desc": "Updating plans and shares after works or sales."
          },
          {
            "title": "3D laser scan & BIM",
        ...
        "missions": [
          {
            ...
            "desc": "Administrative file for subdivision creations."
          },
          {
            "title": "Design & Layout",
            "desc": "Sketches, master plans, and landscape integration."
          },
          {
            "title": "Project management",
            "desc": "Supervision of servicing and roadworks construction."
          },
          {
            "title": "Subdivision boundary marking",
        ...
        "missions": [
          {
            ...
            "desc": "Analysis of sites and development scenarios."
          },
          {
            "title": "Eco-neighborhoods & ZAC",
            "desc": "Creation of new sustainable city neighborhoods."
          },
          {
            "title": "Public spaces",
            "desc": "Design of squares, streets, parks, and paths."
          },
          {
      ...
      "vrd": {
        ...
        "missions": [
          {
            "title": "VRD Project Management",
            "desc": "Design, procurement, and supervision of construction works."
          },
          {
            "title": "Stormwater management",
            "desc": "Sizing of retention basins, swales, and eco-friendly techniques."
          },
          {
            "title": "Servicing studies",
            "desc": "Calculations of network slopes and road structural sizing."
          },
          {
            "title": "Roundabout & Parking design",
      ...
      "sport": {
        ...
        "missions": [
          {
            "title": "Large game fields",
            "desc": "Football and rugby fields in synthetic grass."
          },
          {
            "title": "Athletics tracks",
            "desc": "Technical tracks with approved synthetic coatings."
          },
          {
            "title": "Local equipment",
            "desc": "City-stadiums, skateparks, and fitness trails."
          },
          {
      ...
      "topographie": {
        ...
        "missions": [
          {
            "title": "Precision plans",
            "desc": "Detailed surveys for architectural studies."
          },
          {
            "title": "3D Scanner & BIM",
            "desc": "Complete 3D scanning of complex buildings."
          },
          {
            "title": "Drone surveys",
            "desc": "Aerial digital terrain modeling of large areas."
          },
          {
            "title": "Staking & Layouts",
      ...
      "geometre": {
        ...
        "missions": [
          {
            "title": "Amicable boundary",
            "desc": "Legal definition and physical staking of property limits."
          },
          {
            "title": "Land division",
            "desc": "Creation of building plots (DMPC cadastral update)."
          ...
          {
            "title": "Co-ownership & Volumes",
            "desc": "Plans and statements for co-ownership or volumes."
          },
          {
  ...
  "references": {
    ...
    "items": [
      ...
      "BRELES: Eco-village in the heart of the village",
      "ZAC & Land divisions: PLOUDALMEZEAU, GUILERS, LAMPAUL-PLOUARZEL",
      "GOUESNOU and CHATEAULIN: New HQE neighborhoods",
      "Village center development: LANILDUT, IRVILLAC, PLOMODIERN",
      "LANNION: Kervouric-Servel Eco-neighborhood",
      "Urban redevelopment: PORSPODER, LAMPAUL-PLOUARZEL",
      "TREBEURDEN (22): Pierre MARZIN Eco-neighborhood",
      "POULLAN-SUR-MER: Park ar Leur sustainable district"
    ]
  },
  "about": {
    "header": {
      "title": "About URBATEAM",
      "subtitle": "Your privileged partner for land planning in Western Brittany."
    },
    "society": {
      "title": "Our Company",
      "p1": "URBATEAM accompanies you throughout your development projects in Western Brittany through our two local offices located in Saint-Renan (near Brest) and Douarnenez.",
    ...
    "team": {
      "title": "Our Team",
      "subtitle": "A friendly, dynamic and multidisciplinary team of about 10 collaborators bringing together Land Surveyors, urban planners, engineers and surveying technicians at the service of your projects' success.",
      "members": {
        "frank": {
          "name": "Frank Le Gall",
          "role": "Co-Manager",
          "desc": "Project management, urban planning & infrastructure.",
        ...
        "laura": {
          ...
          "role": "Co-Manager",
          "desc": "Land issues, topography & management.",
        ...
        "yves": {
          ...
          "desc": "Expert in road design and diverse networks.",
        ...
        "trang": {
          "name": "Trang Stephan",
          "role": "Infrastructure Project Manager",
          "desc": "Specialist in technical design and infrastructure monitoring.",
        ...
        "camille": {
          ...
          "desc": "Landscape design and environmental integration.",
          "email": "camille.lormeteau@urbateam.fr",
          "phone": "06 78 73 03 26"
        },
        "urbanistes": {
          "role": "Urban Planners & Landscape Architects",
          "desc": "Design and development of urban spaces."
        },
        "engineers": {
          "role": "Infrastructure Engineers",
          "desc": "Technical design of roads and networks."
        },
        "topographers": {
          "role": "Surveying Technicians",
          "desc": "High-precision field surveys and layouts."
        },
        "drafters": {
          "role": "Draftspeople",
          "desc": "3D modeling and production of development plans."
        },
        "lawyers": {
          "role": "Legal Experts",
          "desc": "Legal support on land law and co-ownership."
        },
        "assistants": {
          "role": "Executive Assistants",
          "desc": "Administrative, financial management and client relations."
        }
      }
    },
    "quality": {
      "title": "Our Quality Approach",
      "subtitle": "URBATEAM is committed to mastering, controlling, enhancing and guaranteeing the quality of the services offered.",
      "engagement": {
        "title": "Quality Commitment",
        "p1": "URBATEAM is committed to guaranteeing the satisfaction of its clients for all urban planning, eco-neighborhood, land expertise or topography projects.",
        "list": [
          "Implementation of an approach ensuring proven quality for the satisfaction of needs and technical intelligence facing problems, for a competitive quality-price ratio.",
          "Absolute respect for the client's functional requirements, incurred costs and completion deadlines.",
          "Concrete translation of needs. An optimum process requires good baseline data and a clear presentation of results."
        ]
      },
      "assurance": {
        "title": "Quality Assurance Plan",
        "p1": "We guarantee the Quality of execution of the assigned missions to the Client by implementing:",
        "list": [
          "The rigorous composition and organization of the team assigned to execute the mission.",
          "The organization of study work and a clear presentation of the proposed documents.",
          "Consultation with the various stakeholders involved (technical services, etc...).",
          "Strict compliance with fixed costs and deadlines."
        ]
      },
      "control": {
        "title": "Quality Control",
        "p1": "All study phases are subject to detailed control. Internal controls, materialized by a verification of the output of each phase, are carried out by the project director.",
        "p2": "This very regular control makes it possible to identify any non-conformities, which systematically lead to a corrective action in real time."
      },
      "communication": {
        "title": "Transparent Communication",
        "p1": "The provisions for communication with the client evolve according to the different phases of mission realization (from design to works).",
        "list": [
          "Communication greatly facilitated thanks to a single point of contact.",
          "Animation of interactive meetings using modern tools."
        ]
      }
    },
    "rse": {
  ...
  "contact": {
    "header": {
      "title": "Contact Us",
      "subtitle": "Whether for a development project, a topographic survey or a land division, our team is at your service."
    },
    "info": {
      "title": "Contact Details",
      "renan": "Saint-Renan Office",
      "douarnenez": "Douarnenez Office",
    ...
    "form": {
      ...
      "success_title": "Thank you, your documents have been successfully transmitted!",
      ...
      "label_motif": "Reason for your request *",
      "motifs": {
        "urban": "Urban planning / Landscape project",
        "infra": "Infrastructure Engineering (VRD)",
  ...
  "project": {
    ...
    "tabs": {
      "division": "🏷️ Divide",
      "bornage": "🚧 Boundary",
      "lotissement": "🏘️ Subdivision",
      "topo": "📐 Survey"
    },
    "types": {
      "division": {
        "title": "Diving land (Parcel detachment)",
        "description": "The complete legal process to divide a property for the purpose of selling a building lot.",
        "steps": [
          {
            "title": "Feasibility Study & Quote",
            "desc": "Analysis of the urban planning document (PLU/PLUi) and land constraints (access, utilities) to ensure the project is buildable and legal."
          },
          {
            "title": "Topographic Survey",
            "desc": "Intervention of our teams on the field to precisely measure the existing situation (boundaries, elevations, visible networks)."
          },
          {
            "title": "Division Project & Boundary Marking",
            "desc": "Creation of the division plan and meeting with neighbors to legally validate the property lines (contradictory boundary marking)."
          },
          {
            "title": "Administrative Validation (DP)",
            "desc": "Submission of the Preliminary Declaration (DP) or Development Permit to the city hall. Instruction usually takes 1 month."
          },
          {
            "title": "Surveying Document (DMPC)",
            "desc": "Upon approval from the city hall, drafting of the official document updating the Tax Cadastre plan."
          },
          {
            "title": "Notary Deed",
            "desc": "The division is now official. The plans and land documents are attached to the promise and then to the notarized deed of sale."
          }
        ]
      },
      "bornage": {
        "title": "Defining my property (Contradictory Boundary Marking)",
        "description": "To know, fix and definitively materialize the legal boundary separating your land from your neighbors'.",
        "steps": [
          {
            "title": "Legal Research & Quote",
            "desc": "Analysis of property titles of the applicant and neighbors, search in land archives and the Cadastre."
          },
          {
            "title": "On-site Survey",
            "desc": "The surveying technician measures physical elements (fences, hedges, walls, old markers)."
          },
          {
            "title": "Contradictory Meeting",
            "desc": "Meeting on the field with ALL neighboring owners to propose and negotiate the future property line."
          },
          {
            "title": "Boundary Marking Minutes (PV)",
            "desc": "Drafting of the official legal act finalizing the agreement. It must be signed by all parties."
          },
          {
            "title": "Staking the Boundaries",
            "desc": "Once the PV is signed, physical materialization of the boundary on the ground (placing markers or surveying nails)."
          },
          {
            "title": "OGE Archiving",
            "desc": "Permanent recording and security of the file on the Order of Chartered Surveyors portal (GéoFoncier), guaranteeing the boundary for life."
          }
        ]
      },
      "lotissement": {
        "title": "Designing a Subdivision / Eco-neighborhood",
        "description": "From a blank page to handing over the network keys: the support of urban project management.",
        "steps": [
          {
            "title": "Sketch & Feasibility",
            "desc": "Development of an initial planning scheme taking into account environmental, legal (PLU) and budgetary constraints."
          },
          {
            "title": "Development Permit (PA)",
            "desc": "Constitution and submission of the complete administrative file to the prefecture or city hall (Water Act, environmental evaluation...)."
          },
          {
            "title": "Tender Documents (DCE)",
            "desc": "Detailed technical development of the project (execution civil engineering plans) and launch of the tender with roadwork companies."
          },
          {
            "title": "Works Direction (MOE)",
            "desc": "Rigorous monitoring of the construction site, weekly meetings, validation of network installation (water, electricity, sanitation)."
          },
          {
            "title": "Site Acceptance (DAACT)",
            "desc": "Resolution of punch list items, environmental compliance check and signature of the completion declaration."
          },
          {
            "title": "Final Staking of Lots",
            "desc": "Final placement of boundary markers for each new lot created before final commercialization."
          }
        ]
      },
      "topo": {
        "title": "Topographic & Architectural Survey",
        "description": "Providing a precise plan (2D/3D) of the existing situation for architectural or engineering purposes.",
        "steps": [
          {
            "title": "Need Definition",
            "desc": "Exchange with the architect or client on the expected level of precision and the final plan scale."
          },
          {
            "title": "Data Acquisition (Field)",
            "desc": "Terrestrial survey with 3D scanner, total station or drone flyover."
          },
          {
            "title": "Office Processing (CAD/BIM)",
            "desc": "Processing of 3D point clouds and software modeling of facades, walls, and elevations (contour lines)."
          },
          {
            "title": "Plan Finalization",
            "desc": "Drafting the streetscape or site plan with all visible networks and vegetation."
          },
          {
            "title": "Architectural Delivery",
            "desc": "Delivery of the validated topographic model (DWG/DXF, PDF and BIM formats)."
          }
        ]
      }
    },
    "geofoncier": {
      "title": "Tool: Is my land already surveyed?",
      "desc": "Before starting a boundary mission, check for free if a boundary has already been defined via the GéoFoncier portal.",
      "btn": "Consult the GéoFoncier portal"
    },
    "cta": {
      "title": "Need clarity to frame your immediate project?",
      "subtitle": "URBATEAM's role is primarily to advise you on its feasibility.",
      "btn": "Contact our experts"
    }
  },
  "technical": {
    "header": {
      "title": "Our Technical Resources",
      "subtitle": "To carry out our missions successfully, URBATEAM relies on state-of-the-art technological equipment and adapted infrastructures."
    },
    "infrastructure": {
      "title": "Offices & Infrastructure",
      "list": [
        "300m² of offices in Saint-Renan (29)",
        "200m² of offices in Douarnenez (29)",
        "Secure high-speed VPN link",
    ...
    "computing": {
      "title": "CAD & Office Department",
      "list": [
        "11 high-performance workstations (CAD / AutoCAD)",
        "4 management and office PCs"
      ]
    },
    "software": {
      "title": "Software Environment",
      "desc": "Computer-aided design, 3D design and software modeling:"
    },
    "reprography": {
      "title": "Reprography & Large Format Printing",
      "list": [
        "2 HP DESIGN JET plotters",
        "1 OCE 7050 large format copier",
        "1 CANON IR ADV laser scanner copier",
        "1 CANON CLC color laser copier",
        "2 CANON IR office copiers",
        "3 CANON A3 color printers",
        "3 HP LASERJET laser printers",
        "1 Professional high-resolution A3 scanner"
      ]
    }
  },
  "faq": {
    ...
    "items": [
      {
        "question": "What is contradictory boundary marking and is it mandatory?",
        "answer": "Boundary marking allows for the legal and definitive fixing of your land's property lines. In France (Article 646 of the Civil Code), any owner can compel their neighbor to boundary marking. This is also legally mandatory in the case of land division for building (subdivision). Only a Chartered Land Surveyor registered with the Order is authorized to carry it out and place official markers."
      },
      {
        "question": "What is the difference between a topographic plan and a boundary plan?",
        "answer": "A topographic plan is a precise survey of the existing situation (relief, walls, trees, roads). It is essential for the architect or project manager but has no legal value concerning the property line. The boundary plan, however, determines the guaranteed legal land boundary after analysis of notarized deeds and contradictory agreement from neighbors."
      },
      {
        "question": "Can I divide my garden land to sell it?",
        "answer": "Yes, but this operation (parcel detachment) requires ensuring the project complies with the local urban plan (PLU/PLUi). The Land Surveyor verifies buildability, creates the division plan, marks the new created boundary and constitutes the mandatory urban planning file (Preliminary Declaration of division) at the City Hall."
      },
      {
    ...
    "cta": {
      ...
      "subtitle": "Our team will be happy to provide you with precise information about your file.",
      "btn": "Ask a question"
    }
  },
  "glossary": {
    ...
    "items": [
      ...
      {
        "term": "Cadastre",
        "definition": "Set of documents establishing the state of land ownership for essentially fiscal purposes. The cadastre does not guarantee the exact legal property boundary."
      },
      {
      ...
      },
      {
        ...
        "definition": "Large-scale public urban planning operation by which a local authority develops land to sell it to builders."
      },
      {
        "term": "Carrez / Boutin Laws",
        "definition": "Measurement of private area (Carrez) for sale or habitable area (Boutin) for rental."
      },
      {
        "term": "HQE (High Environmental Quality)",
        "definition": "Development approach aiming to master the environmental impacts of an urban or real estate operation."
      },
      {
        "term": "Project Management (MOE)",
        "definition": "Person or entity appointed by the project owner to design, study and direct the execution of works."
      },
      {
    ...
    "cta": {
      "title": "Is a term eluding you for your project?",
      "subtitle": "Do not hesitate to request our land surveyors for pedagogical support.",
      "btn": "Contact us"
    }
  },
  "footer": {
  ...
  "cookies_banner": {
    ...
    "text": "URBATEAM uses technical cookies necessary for the proper functioning of the site. To learn more about our data management, consult our ",
  ...
  "legal_pages": {
    "common": {
      ...
      "email": "Email",
      "phone": "Phone",
      "more_info": "To learn more, you can consult the website of the ",
      "contact_text": "You can exercise these rights by contacting us at "
    },
    "mentions": {
      "title": "Legal Notice",
      "editor": "Site Editor",
      "contact": "Contact",
      "hosting": "Hosting",
      "hosting_desc": "This site is hosted by **Vercel Inc.** The infrastructure relies on a high-performance global Cloud network ensuring data security, continuous SSL encryption, and GDPR compliance."
    },
    "privacy": {
    ...
    "cookies": {
      ...
      "desc": "A cookie is a small text file placed on your terminal (computer, tablet, smartphone) when visiting a site.",
      "usage": "Cookies used on this site",
  ...
  "division": {
    ...
    "lot_a": "Lot A",
    "lot_b": "Lot B",
    "lot_a_constructible": "Lot A ({surface} sq.m.): Favorable surface (recommended > 150m², to be confirmed per local PLU)",
    "lot_a_not_constructible": "Lot A ({surface} sq.m.): Small surface (caution for detaching a lot, to be validated per PLU)",
    "lot_b_constructible": "Lot B ({surface} sq.m.): Favorable surface (recommended > 150m², to be confirmed per local PLU)",
    "lot_b_not_constructible": "Lot B ({surface} sq.m.): Small surface (caution for detaching a lot, to be validated per PLU)",
