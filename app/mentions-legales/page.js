    ...
    <div className="container py-section">
      ...
      <GlassCard style={{ maxWidth: '800px', margin: '0 auto', padding: '3rem' }}>
        <div style={{ marginBottom: '2rem' }}>
          ...
          <p><strong>{t('legal_pages.common.reason')} :</strong> Urbateam SELARL</p>
        ...
        <div style={{ marginBottom: '2rem' }}>
          ...
          <div className="grid grid-cols-2" style={{ marginTop: '1.5rem', gap: '2rem' }}>
            <div>
              ...
              <p style={{ margin: '0.2rem 0' }}><strong>{t('legal_pages.common.address')} :</strong> Za Ste Croix, 5 Rue Breiz Izel, 29100 Douarnenez, France</p>
